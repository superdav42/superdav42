...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 18.2h | 24h | 24h | ~3,694h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 6,164 | 135.7M | 1.9M | 709.0M | $3,880.74 | $9,572.58 | $0.00 |
| claude-sonnet-4-6 | 58,451 | 5.2M | 17.6M | 4,934.1M | $2,250.01 | $13,322.31 | $7,042.67 |
...
| claude-haiku-4-5 | 53 | 214 | 8K | 1.4M | $0.24 | $1.06 | $2.72 |
| claude-haiku-4-5 | 2 | 45K | 462 | 21K | $0.06 | $0.02 | $0.71 |
| **Total** | **66,229** | **149.8M** | **20.0M** | **5,748.6M** | **$6,216.39** | **$23,246.33** | **$7,300.03** |

_6,084.3M total tokens processed. 94.5% cache hit rate._

_$30,546.35 total saved ($23,246.33 caching + $7,300.03 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 6,235 | 135.7M | 1.9M | 712.7M | $3,253.96 | $9,622.74 | $0.00 |
| claude-sonnet-4-6 | 55,535 | 5.1M | 16.8M | 4,790.6M | $1,704.98 | $12,934.75 | $6,820.00 |
...
| **Total** | **63,448** | **149.2M** | **19.3M** | **5,622.0M** | **$5,039.06** | **$22,964.16** | **$7,081.76** |

_5,959.6M total tokens processed. 94.4% cache hit rate._

_$30,045.91 total saved ($22,964.16 caching + $7,081.76 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-03 10:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
