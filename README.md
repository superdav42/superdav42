...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 12.2h | 12.2h | 12.2h | ~3,621h* |
| User AI session hours | 4.9h | 54.2h | 93.3h | 93.3h |
| AI worker hours | 0.7h | 30.9h | 61.6h | 61.6h |
| AI concurrency hours | 12.9h | 135.9h | 236.6h | 236.6h |
| Interactive sessions | 31 | 218 | 300 | 300 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 16,397 | 135.7M | 6.5M | 2,020.4M | $7,405.80 | $27,275.79 | $0.00 |
...
| hf:zai-org/GLM-5.1 | 221 | 1.3M | 61K | 11.6M | $8.49 | $31.43 | $33.95 |
...
| **Total** | **98,646** | **152.9M** | **30.8M** | **8,558.0M** | **$10,510.41** | **$45,066.94** | **$9,499.95** |

_9,027.3M total tokens processed. 94.8% cache hit rate._

_$54,566.90 total saved ($45,066.94 caching + $9,499.95 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 16,477 | 135.7M | 6.4M | 2,016.5M | $5,547.90 | $27,223.65 | $0.00 |
...
| hf:zai-org/GLM-5.1 | 222 | 1.3M | 61K | 11.6M | $8.47 | $31.43 | $33.95 |
...
| **Total** | **93,319** | **152.4M** | **29.3M** | **8,258.4M** | **$7,837.97** | **$44,266.91** | **$9,038.53** |

_8,731.5M total tokens processed. 94.7% cache hit rate._

_$53,305.44 total saved ($44,266.91 caching + $9,038.53 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-14 05:26 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
