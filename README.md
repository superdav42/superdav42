...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 24h | 24h | 24h | ~3,559h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 6,158 | 135.7M | 1.9M | 708.6M | $3,876.16 | $9,567.30 | $0.00 |
| claude-sonnet-4-6 | 55,985 | 5.1M | 17.0M | 4,702.6M | $2,149.07 | $12,697.03 | $6,727.79 |
...
| **Total** | **63,757** | **149.8M** | **19.4M** | **5,516.6M** | **$6,110.87** | **$22,615.77** | **$6,985.15** |

_5,845.6M total tokens processed. 94.4% cache hit rate._

_$29,600.92 total saved ($22,615.77 caching + $6,985.15 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 6,229 | 135.7M | 1.9M | 712.4M | $3,253.26 | $9,617.46 | $0.00 |
| claude-sonnet-4-6 | 53,757 | 5.1M | 16.3M | 4,591.6M | $1,638.29 | $12,397.44 | $6,553.21 |
...
| **Total** | **61,664** | **149.2M** | **18.8M** | **5,422.6M** | **$4,971.67** | **$22,421.57** | **$6,814.97** |

_5,754.7M total tokens processed. 94.3% cache hit rate._

_$29,236.54 total saved ($22,421.57 caching + $6,814.97 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-03 00:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
