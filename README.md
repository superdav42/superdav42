...
| Interactive sessions | 25 | 747 | 2,018 | 3,914 |
| Worker sessions | 60 | 369 | 767 | 2,579 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 11,907 | 53.9M | 2.5M | 937.2M | $434.31 | $2,530.69 | $1,927.05 |
...
| **Total** | **14,281** | **72.0M** | **3.1M** | **1,107.2M** | **$573.85** | **$2,989.45** | **$2,380.26** |

_1,182.4M total tokens processed. 93.6% cache hit rate._

_$5,369.70 total saved ($2,989.45 caching + $2,380.26 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-16 09:18 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
