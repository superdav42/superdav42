...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 20.7h | 24h | 24h | ~2,993h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,433 | 23K | 6.8M | 2,036.6M | $875.31 | $5,498.98 | $2,855.23 |
...
| **Total** | **26,481** | **4.8M** | **7.8M** | **2,437.0M** | **$1,744.00** | **$10,362.41** | **$2,984.95** |

_2,506.3M total tokens processed. 97.2% cache hit rate._

_$13,347.36 total saved ($10,362.41 caching + $2,984.95 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,814 | 24K | 6.8M | 2,048.0M | $717.77 | $5,529.69 | $2,871.12 |
...
| **Total** | **27,108** | **6.2M** | **7.9M** | **2,469.5M** | **$1,346.72** | **$10,462.71** | **$3,047.70** |

_2,540.5M total tokens processed. 97.2% cache hit rate._

_$13,510.41 total saved ($10,462.71 caching + $3,047.70 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-03-26 22:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
