...
| Interactive sessions | 326 | 761 | 2,020 | 3,743 |
| Worker sessions | 94 | 244 | 613 | 2,402 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 9,273 | 40.7M | 1.9M | 709.3M | $329.05 | $1,915.15 | $1,458.39 |
...
| **Total** | **10,518** | **50.7M** | **2.2M** | **771.1M** | **$400.53** | **$2,082.03** | **$1,667.21** |

_824.1M total tokens processed. 93.6% cache hit rate._

_$3,749.24 total saved ($2,082.03 caching + $1,667.21 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-13 09:36 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
