...
| User AI session hours | 6.9h | 28.0h | 65.3h | 65.3h |
| AI worker hours | 4.6h | 21.1h | 65.2h | 65.2h |
| AI concurrency hours | 21.5h | 112.3h | 236.8h | 236.8h |
| Interactive sessions | 33 | 354 | 489 | 489 |
| Worker sessions | 23 | 81 | 228 | 228 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 24,218 | 135.7M | 10.1M | 3,086.2M | $10,170.94 | $41,664.11 | $0.00 |
| claude-sonnet-4-6 | 73,297 | 5.2M | 26.5M | 6,086.1M | $2,978.97 | $16,432.55 | $8,960.28 |
...
| big-pickle | 566 | 3.9M | 125K | 31.2M | $26.77 | $0.00 | $115.53 |
...
| **Total** | **103,226** | **200.9M** | **38.1M** | **9,527.4M** | **$13,620.70** | **$59,274.97** | **$10,199.98** |

_10,117.5M total tokens processed. 94.2% cache hit rate._

_$69,474.95 total saved ($59,274.97 caching + $10,199.98 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 8,173 | 9K | 3.3M | 1,169.1M | $2,002.45 | $15,783.85 | $0.00 |
...
| **Total** | **36,144** | **40.8M** | **15.4M** | **3,735.2M** | **$3,165.88** | **$23,353.02** | **$4,211.18** |

_4,106.4M total tokens processed. 95.3% cache hit rate._

_$27,564.20 total saved ($23,353.02 caching + $4,211.18 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-28 03:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
