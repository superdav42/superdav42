...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 24h | 75.6h | 291.2h | ~4252h* |
...
| Interactive sessions | 128 | 517 | 1,742 | 3,436 |
| Worker sessions | 38 | 171 | 520 | 2,309 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 8,232 | 33.9M | 1.7M | 627.0M | $285.38 | $1,692.92 | $1,262.97 |
...
| **Total** | **8,864** | **41.7M** | **1.8M** | **653.4M** | **$325.18** | **$1,764.24** | **$1,396.48** |

_697.0M total tokens processed. 93.7% cache hit rate._

_$3,160.72 total saved ($1,764.24 caching + $1,396.48 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-12 06:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
