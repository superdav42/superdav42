...
| User AI session hours | 2.3h | 53.8h | 90.6h | 90.6h |
| AI worker hours | 4.6h | 32.3h | 69.8h | 69.8h |
| AI concurrency hours | 8.7h | 128.9h | 237.6h | 237.6h |
| Interactive sessions | 10 | 173 | 269 | 269 |
| Worker sessions | 22 | 136 | 290 | 290 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 15,538 | 135.7M | 6.1M | 1,952.7M | $7,196.37 | $26,362.19 | $0.00 |
| claude-sonnet-4-6 | 76,599 | 5.2M | 22.5M | 6,191.7M | $2,884.73 | $16,717.67 | $8,844.12 |
...
| **Total** | **94,550** | **151.3M** | **29.2M** | **8,288.6M** | **$10,199.46** | **$43,608.75** | **$9,164.92** |

_8,745.7M total tokens processed. 94.8% cache hit rate._

_$52,773.67 total saved ($43,608.75 caching + $9,164.92 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 15,583 | 135.7M | 6.1M | 1,949.1M | $5,418.11 | $26,313.93 | $0.00 |
| claude-sonnet-4-6 | 71,647 | 5.2M | 21.1M | 5,914.0M | $2,107.19 | $15,968.04 | $8,428.82 |
...
| **Total** | **89,405** | **150.7M** | **27.8M** | **8,004.9M** | **$7,630.63** | **$42,854.69** | **$8,728.22** |

_8,465.7M total tokens processed. 94.6% cache hit rate._

_$51,582.91 total saved ($42,854.69 caching + $8,728.22 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-12 03:25 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
