...
| Interactive sessions | 139 | 528 | 1,753 | 3,447 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 8,243 | 33.9M | 1.7M | 627.2M | $285.62 | $1,693.69 | $1,264.00 |
...
| **Total** | **8,875** | **41.7M** | **1.8M** | **653.7M** | **$325.42** | **$1,765.01** | **$1,397.50** |

_697.4M total tokens processed. 93.7% cache hit rate._

_$3,162.51 total saved ($1,765.01 caching + $1,397.50 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-12 07:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
