...
| Interactive sessions | 59 | 301 | 301 | 301 |
| Worker sessions | 56 | 456 | 1,371 | 1,371 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 18,137 | 83.0M | 4.0M | 1,314.5M | $634.16 | $3,549.19 | $2,818.78 |
| gpt-5.6-sol | 4,478 | 26.0M | 1.0M | 446.8M | $406.96 | $1,206.56 | $911.98 |
| gpt-5.6-terra | 7,377 | 53.2M | 2.0M | 810.7M | $398.55 | $2,188.95 | $1,732.48 |
...
| **Total** | **30,212** | **168.5M** | **7.1M** | **2,580.3M** | **$1,459.23** | **$6,965.41** | **$5,549.71** |

_2,756.1M total tokens processed. 93.6% cache hit rate._

_$12,515.12 total saved ($6,965.41 caching + $5,549.71 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-23 15:11 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
