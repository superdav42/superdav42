...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 19.7h | 24h | 24h | ~2,993h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,286 | 23K | 6.8M | 2,028.7M | $871.56 | $5,477.58 | $2,843.38 |
...
| **Total** | **26,334** | **4.8M** | **7.7M** | **2,429.1M** | **$1,740.25** | **$10,341.01** | **$2,973.09** |

_2,498.1M total tokens processed. 97.2% cache hit rate._

_$13,314.11 total saved ($10,341.01 caching + $2,973.09 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,664 | 23K | 6.8M | 2,040.1M | $714.81 | $5,508.29 | $2,859.26 |
...
| **Total** | **26,958** | **6.2M** | **7.9M** | **2,461.6M** | **$1,343.76** | **$10,441.30** | **$3,035.84** |

_2,532.3M total tokens processed. 97.2% cache hit rate._

_$13,477.15 total saved ($10,441.30 caching + $3,035.84 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-03-26 21:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
