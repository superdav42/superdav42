...
| User AI session hours | 8.3h | 28.0h | 70.1h | 70.1h |
| AI worker hours | 0.0h | 16.8h | 65.2h | 65.2h |
| AI concurrency hours | 16.3h | 105.5h | 245.2h | 245.2h |
| Interactive sessions | 14 | 338 | 491 | 491 |
| Worker sessions | 0 | 72 | 228 | 228 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 25,108 | 135.7M | 10.5M | 3,282.9M | $10,593.35 | $44,320.14 | $0.00 |
...
| **Total** | **102,227** | **200.8M** | **37.9M** | **9,591.0M** | **$13,981.41** | **$61,576.70** | **$10,001.70** |

_10,182.7M total tokens processed. 94.2% cache hit rate._

_$71,578.40 total saved ($61,576.70 caching + $10,001.70 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 9,065 | 10K | 3.6M | 1,365.9M | $2,325.74 | $18,439.87 | $0.00 |
...
| **Total** | **37,107** | **40.8M** | **15.9M** | **3,943.0M** | **$3,493.29** | **$26,039.01** | **$4,227.64** |

_4,320.3M total tokens processed. 95.4% cache hit rate._

_$30,266.64 total saved ($26,039.01 caching + $4,227.64 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-28 22:34 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
