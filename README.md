...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 10h | 37.4h | 97.5h | ~4,811h* |
| User AI session hours | 10.9h | 43.8h | 142.8h | 499.6h |
| AI worker hours | 5.6h | 15.7h | 64.7h | 340.4h |
| AI concurrency hours | 37.8h | 135.4h | 452.9h | 1,537.5h |
| Interactive sessions | 65 | 338 | 1,284 | 2,749 |
| Worker sessions | 25 | 132 | 491 | 1,833 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 5,455 | 23.1M | 1.1M | 419.0M | $192.75 | $1,131.52 | $851.43 |
| qwen3.6-100k:latest | 102 | 5.4M | 46K | 0 | $16.91 | $0.00 | $67.65 |
| **Total** | **5,557** | **28.5M** | **1.2M** | **419.0M** | **$209.66** | **$1,131.52** | **$919.08** |

_448.9M total tokens processed. 93.3% cache hit rate._

_$2,050.60 total saved ($1,131.52 caching + $919.08 model routing vs all-Opus)._
...
| gpt-5.5 | 105,140 | 475.6M | 20.4M | 7,941.6M | $4,115.73 | $21,442.51 | $16,462.97 |
...
| **Total** | **230,232** | **574.8M** | **81.2M** | **20,282.4M** | **$18,837.85** | **$125,843.88** | **$26,303.98** |

_21,703.2M total tokens processed. 94.7% cache hit rate._

_$152,147.86 total saved ($125,843.88 caching + $26,303.98 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-10 08:06 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
