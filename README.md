...
| Interactive sessions | 134 | 816 | 2,093 | 3,863 |
| Worker sessions | 93 | 304 | 689 | 2,479 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 10,684 | 46.9M | 2.2M | 829.2M | $382.98 | $2,239.06 | $1,696.22 |
...
| **Total** | **12,163** | **58.3M** | **2.5M** | **908.8M** | **$469.46** | **$2,453.84** | **$1,945.94** |

_969.8M total tokens processed. 93.7% cache hit rate._

_$4,399.78 total saved ($2,453.84 caching + $1,945.94 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-14 12:38 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
