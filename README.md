...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 15.7h | 24h | 24h | ~2,993h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 22,714 | 23K | 6.6M | 1,994.1M | $852.35 | $5,384.32 | $2,792.92 |
...
| **Total** | **25,739** | **4.6M** | **7.6M** | **2,393.7M** | **$1,720.03** | **$10,245.40** | **$2,918.61** |

_2,460.6M total tokens processed. 97.3% cache hit rate._

_$13,164.01 total saved ($10,245.40 caching + $2,918.61 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,080 | 23K | 6.6M | 2,005.4M | $702.16 | $5,414.84 | $2,808.71 |
...
| **Total** | **26,351** | **6.0M** | **7.7M** | **2,426.1M** | **$1,330.11** | **$10,345.50** | **$2,981.26** |

_2,494.7M total tokens processed. 97.3% cache hit rate._

_$13,326.77 total saved ($10,345.50 caching + $2,981.26 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-03-26 17:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
