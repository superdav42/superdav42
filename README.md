...
| Interactive sessions | 29 | 29 | 29 | 1,804 |
| Worker sessions | 75 | 820 | 990 | 2,780 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 13,156 | 59.9M | 2.8M | 1,056.8M | $486.22 | $2,853.43 | $2,157.36 |
...
| **Total** | **16,553** | **86.7M** | **3.6M** | **1,336.1M** | **$711.29** | **$3,607.59** | **$2,862.91** |

_1,426.5M total tokens processed. 93.7% cache hit rate._

_$6,470.50 total saved ($3,607.59 caching + $2,862.91 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-17 11:36 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
