...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 13.6h | 41.5h | 213.9h | ~4,460h* |
| User AI session hours | 5.3h | 42.7h | 94.0h | 94.0h |
| AI worker hours | 12.0h | 39.6h | 105.4h | 105.4h |
| AI concurrency hours | 25.3h | 139.6h | 310.0h | 310.0h |
| Interactive sessions | 29 | 128 | 272 | 272 |
| Worker sessions | 25 | 151 | 470 | 470 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-7 | 27,778 | 35K | 19.8M | 3,192.8M | $9,576.06 | $43,103.72 | $0.00 |
| gpt-5.5 | 26,663 | 102.5M | 4.6M | 1,954.9M | $847.35 | $5,278.33 | $3,855.84 |
| claude-sonnet-4-6 | 17,669 | 18K | 8.5M | 1,397.1M | $678.66 | $3,772.40 | $2,191.41 |
...
| gpt-5.3-codex-spark | 619 | 1.9M | 100K | 24.7M | $23.16 | $46.38 | $52.59 |
| qwen3.6-plus-free | 256 | 1K | 40K | 36.8M | $18.10 | $99.54 | $46.71 |
| claude-opus-4-8 | 26 | 42 | 88K | 2.3M | $15.37 | $31.43 | $0.00 |
| minimax-m2.5-free | 507 | 811K | 116K | 25.9M | $11.96 | $0.00 | $59.80 |
| z-ai/glm-5.1 | 40 | 1.7M | 3K | 0 | $5.23 | $0.00 | $20.92 |
| big-pickle | 141 | 498K | 34K | 5.3M | $3.84 | $0.00 | $18.11 |
| deepseek-ai/deepseek-v4-pro | 6 | 724K | 2K | 0 | $2.21 | $0.00 | $8.84 |
...
| moonshotai/kimi-k2.6 | 2 | 121K | 128 | 0 | $0.37 | $0.00 | $1.83 |
...
| **Total** | **87,683** | **146.9M** | **37.0M** | **7,442.8M** | **$11,678.47** | **$54,633.16** | **$7,878.05** |

_7,858.0M total tokens processed. 94.7% cache hit rate._

_$62,511.21 total saved ($54,633.16 caching + $7,878.05 model routing vs all-Opus)._
...
| gpt-5.5 | 27,177 | 104.3M | 4.7M | 1,989.3M | $862.35 | $5,371.29 | $3,924.25 |
...
| gpt-5.4-mini | 25 | 92K | 3K | 824K | $0.07 | $1.55 | $2.11 |
| **Total** | **257,193** | **359.9M** | **97.6M** | **23,378.9M** | **$30,873.63** | **$146,042.30** | **$25,423.96** |

_24,598.2M total tokens processed. 95% cache hit rate._

_$171,466.25 total saved ($146,042.30 caching + $25,423.96 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-04 03:41 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
