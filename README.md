...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 5,846 | 135.7M | 1.8M | 665.2M | $3,749.30 | $8,981.07 | $0.00 |
| claude-sonnet-4-6 | 55,525 | 5.1M | 16.9M | 4,658.1M | $2,130.82 | $12,576.96 | $6,667.40 |
...
| **Total** | **62,985** | **149.8M** | **19.2M** | **5,428.7M** | **$5,965.76** | **$21,909.47** | **$6,924.76** |

_5,753.7M total tokens processed. 94.4% cache hit rate._

_$28,834.23 total saved ($21,909.47 caching + $6,924.76 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 5,914 | 135.7M | 1.8M | 668.3M | $3,180.31 | $9,023.27 | $0.00 |
...
| **Total** | **61,089** | **149.2M** | **18.6M** | **5,345.8M** | **$4,887.84** | **$21,738.70** | **$6,771.48** |

_5,674.2M total tokens processed. 94.3% cache hit rate._

_$28,510.18 total saved ($21,738.70 caching + $6,771.48 model routing vs all-Opus)._
