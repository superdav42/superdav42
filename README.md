...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 16.7h | 24h | 24h | ~2,993h* |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 22,715 | 23K | 6.6M | 1,994.1M | $852.94 | $5,384.32 | $2,792.93 |
...
| **Total** | **25,740** | **4.6M** | **7.6M** | **2,393.7M** | **$1,720.62** | **$10,245.40** | **$2,918.62** |

_2,460.7M total tokens processed. 97.3% cache hit rate._

_$13,164.02 total saved ($10,245.40 caching + $2,918.62 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 23,085 | 23K | 6.6M | 2,005.4M | $702.17 | $5,414.84 | $2,808.72 |
...
| **Total** | **26,356** | **6.0M** | **7.7M** | **2,426.1M** | **$1,330.12** | **$10,345.50** | **$2,981.27** |

_2,494.9M total tokens processed. 97.2% cache hit rate._

_$13,326.78 total saved ($10,345.50 caching + $2,981.27 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-03-26 18:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
