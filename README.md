...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 8.4h | 36.3h | 208.7h | ~4,460h* |
| User AI session hours | 9.1h | 45.4h | 98.3h | 98.3h |
| AI worker hours | 10.9h | 43.5h | 105.3h | 105.3h |
| AI concurrency hours | 33.4h | 149.4h | 317.7h | 317.7h |
| Interactive sessions | 39 | 135 | 284 | 284 |
| Worker sessions | 26 | 162 | 476 | 476 |
...
| gpt-5.5 | 26,364 | 99.9M | 4.5M | 1,909.1M | $827.30 | $5,154.71 | $3,764.75 |
...
| minimax-m2.5-free | 683 | 952K | 153K | 41.9M | $17.74 | $0.00 | $88.72 |
...
| **Total** | **87,910** | **145.0M** | **37.1M** | **7,452.8M** | **$11,750.26** | **$55,030.40** | **$7,825.42** |

_7,867.1M total tokens processed. 94.7% cache hit rate._

_$62,855.82 total saved ($55,030.40 caching + $7,825.42 model routing vs all-Opus)._
...
| gpt-5.4-mini | 25 | 92K | 3K | 824K | $0.07 | $1.55 | $2.11 |
| **Total** | **256,380** | **355.4M** | **97.4M** | **23,298.7M** | **$30,838.58** | **$145,825.72** | **$25,264.46** |

_24,513.3M total tokens processed. 95% cache hit rate._

_$171,090.18 total saved ($145,825.72 caching + $25,264.46 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-06-03 19:40 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
