...
| Interactive sessions | 28 | 28 | 28 | 1,803 |
| Worker sessions | 73 | 818 | 988 | 2,778 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 13,153 | 59.9M | 2.8M | 1,056.7M | $486.19 | $2,853.33 | $2,157.24 |
...
| **Total** | **16,550** | **86.7M** | **3.6M** | **1,336.1M** | **$711.26** | **$3,607.48** | **$2,862.80** |

_1,426.5M total tokens processed. 93.7% cache hit rate._

_$6,470.28 total saved ($3,607.48 caching + $2,862.80 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-17 10:36 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
