...
| Interactive sessions | 425 | 860 | 2,119 | 3,842 |
| Worker sessions | 142 | 292 | 660 | 2,449 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 10,479 | 45.4M | 2.2M | 819.1M | $375.36 | $2,211.82 | $1,661.55 |
...
| **Total** | **11,933** | **56.1M** | **2.5M** | **896.0M** | **$459.24** | **$2,419.38** | **$1,899.93** |

_954.8M total tokens processed. 93.8% cache hit rate._

_$4,319.31 total saved ($2,419.38 caching + $1,899.93 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-14 02:38 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
