...
| --- | ---: | ---: | ---: | ---: |
| Screen time (Linux) | 8.1h | 21.9h | 125.9h | ~4,643h* |
| User AI session hours | 7.3h | 36.0h | 136.8h | 488.0h |
| AI worker hours | 2.9h | 16.4h | 63.1h | 337.3h |
| AI concurrency hours | 17.9h | 121.7h | 429.3h | 1,498.7h |
| Interactive sessions | 53 | 328 | 1,266 | 2,676 |
| Worker sessions | 24 | 122 | 469 | 1,802 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| gpt-5.5 | 736 | 3.0M | 140K | 47.2M | $23.49 | $127.47 | $101.94 |
| qwen3.6-100k:latest | 10 | 217K | 2K | 0 | $0.70 | $0.00 | $2.79 |
| **Total** | **746** | **3.2M** | **143K** | **47.2M** | **$24.19** | **$127.47** | **$104.73** |

_50.6M total tokens processed. 93.2% cache hit rate._

_$232.19 total saved ($127.47 caching + $104.73 model routing vs all-Opus)._
...
| gpt-5.5 | 100,410 | 455.4M | 19.3M | 7,569.8M | $3,928.38 | $20,438.63 | $15,713.62 |
...
| **Total** | **225,403** | **549.4M** | **80.2M** | **19,910.6M** | **$18,634.08** | **$124,840.00** | **$25,488.75** |

_21,304.9M total tokens processed. 94.8% cache hit rate._

_$150,328.76 total saved ($124,840.00 caching + $25,488.75 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-07-08 23:47 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
