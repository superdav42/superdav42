...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 43,688 | 44K | 13.3M | 3,851.7M | $1,675.00 | $10,399.80 | $5,425.26 |
...
| **Total** | **47,847** | **5.8M** | **14.6M** | **4,348.1M** | **$2,806.35** | **$16,474.45** | **$5,578.13** |

_4,472.6M total tokens processed. 97.2% cache hit rate._

_$22,052.58 total saved ($16,474.45 caching + $5,578.13 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-sonnet-4-6 | 44,869 | 45K | 13.6M | 3,947.4M | $1,389.22 | $10,658.01 | $5,556.94 |
...
| **Total** | **49,288** | **7.2M** | **15.0M** | **4,465.7M** | **$2,179.95** | **$16,812.96** | **$5,756.67** |

_4,593.8M total tokens processed. 97.2% cache hit rate._

_$22,569.63 total saved ($16,812.96 caching + $5,756.67 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-03-29 02:00 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
